...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      link: ['vue', '#fff'],
      classN: ['h2', 'cabecalho ccolor', 'menu-below-700 mcolor', 'mcolor-ul-li-a', 'bcolor',  'App','menu'],//0-6
  ...
  fLightOurDark = () => {
    if (this.state.lightOurDark === iconLight) {
      ...
      this.setState({ classN: ['h2', 'cabecalho ccolor', 'menu-below-700 mcolor', 'mcolor-ul-li-a', 'bcolor', 'App','menu'] })
      this.setState({
        link: ['vue', '#fff']
      })
    }
      ...
      this.setState({ classN: ['dh2', 'cabecalho cdcolor', 'menu-below-700 mdcolor', 'mdcolor-ul-li-a', 'bdcolor', 'App','menu'] })
      this.setState({
        link: ['dark', '#000']
      })
    }
  ...
  fMenu = () =>{
    if (this.state.display[0] === 'mdcolor-ul-close') {
      this.setState({ display: ['mdcolor-ul','button-light-dark','cabecalho','']})
    }
    else {
      ...
      <div className={classN[5]}>
        <header className={classN[1]+' '+display[2]}>
          <div onClick={this.fMenu} className={classN[2]}>
            <svg id='svg' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill={link[1]}><path d="M24 6h-24v-4h24v4zm0 4h-24v4h24v-4zm0 8h-24v4h24v-4z" /></svg>
          </div>
          <nav className={classN[6]}>
            <ul className={display[0]} >
              <li><a onClick={this.fMenu} className={classN[3]} href='#personal'>PERSONAL STATEMENT</a>  </li>
              <li><a onClick={this.fMenu} className={classN[3]} href='#experience'>EXPERIENCE</a>  </li>
              <li><a onClick={this.fMenu} className={classN[3]} href='#projects'>PROJECTS</a>  </li>
              <li><a onClick={this.fMenu} className={classN[3]} href='#github'>GITHUB</a>  </li>
              <li><a onClick={this.fMenu} className={classN[3]} href='#repositories'>REPOSITORIES</a></li>
              <li><a onClick={this.fMenu} className={classN[3]} href='#education'>EDUCATION</a>  </li>
              <li><a onClick={this.fMenu} className={classN[3]} href='#contact'>CONTACT</a>  </li>
            </ul>
          </nav>
        ...
        <div className={classN[4]}>
          <div className='stats'>
            ...
            <div><br id='personal'/><h2 className={classN[0]}>Personal Statemente:</h2> <Psta /> </div>
            ...
            <div><br id='repositories'/> <h2 className={classN[0]} >Repositories:</h2> <Repo /> </div>
